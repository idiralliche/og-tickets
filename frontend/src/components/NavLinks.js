...
const NavLinks = ({ onLinkClick }) => {
  return (
    <>
      ...
      <ul className="nav-links">
        <li><Link data-testid="nav-link-cart" to="/panier" onClick={onLinkClick} className='iconlink'>
          <span className="nav-link-icon cart"><FaShoppingBag /></span>
          <span className="nav-link-text">Panier</span>
        </Link></li>
        <li><Link data-testid="nav-link-login" to="/se-connecter" onClick={onLinkClick} className='iconlink'>
